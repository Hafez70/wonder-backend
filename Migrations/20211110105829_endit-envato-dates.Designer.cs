...
namespace WTLicVerify.Migrations
{
    ...
    [Migration("20211110105829_endit-envato-dates")]
    partial class enditenvatodates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WTLicVerify.Models.EnvatoAccess", b =>
                {
                    b.HasOne("WTLicVerify.Models.AuthorSale", "AuthorSale")
                        .WithMany("EnvatoAccess")
                        .HasForeignKey("authorSaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AuthorSale");
                });
